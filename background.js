...
export class Background {
    constructor(game) {
        ...
        this.layer9 = new Layer(this.game, this.width, this.height, 0, this.layer9image);
        ...
        this.layer6 = new Layer(this.game, this.width, this.height, 0.7, this.layer6image);
        this.layer7 = new Layer(this.game, this.width, this.height, 1, this.layer7image);
        this.layer8 = new Layer(this.game, this.width, this.height, 0, this.layer8image);
        this.backgroundLayers = [this.layer9, this.layer1, this.layer2, this.layer3, this.layer4, this.layer5, this.layer6, this.layer7, this.layer8];
    }
    update() {
